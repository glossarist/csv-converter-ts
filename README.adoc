...
. Include a Github Actions workflow that builds the site and deploys it at specified domain name,
given preconfigured infrastructure
. Render static HTML site locally
